...
def img2tensor(
    ...
    Args:
        ...
        ascontiguousarray (bool): Whether to make array contiguos
    ...
    def _totensor(img, bgr2rgb, float32, ascontiguousarray):
    ...
    if isinstance(imgs, list):
        return [_totensor(img, bgr2rgb, float32, ascontiguousarray) for img in imgs]
    else:
        return _totensor(imgs, bgr2rgb, float32, ascontiguousarray)
